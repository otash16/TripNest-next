...
// import { propertyGuests, propertyYears } from '../../config';
...
// 							<span>
// 								{' '}
// 								{searchFilter?.search?.typeList ? searchFilter?.search?.typeList[0] : t('Destination type')}{' '}
// 							</span>
// 							<ExpandMoreIcon />
// 						</Box>
// 						{/* <Box className={`box ${openRooms ? 'on' : ''}`} onClick={roomStateChangeHandler}>
// 							<span>
// 								{searchFilter?.search?.roomsList ? `${searchFilter?.search?.roomsList[0]} guests}` : t('Guests')}
// 							</span>
// 							<ExpandMoreIcon />
// 						</Box> */}
// 					</Stack>
...
// 											<FormControl sx={{ width: '122px' }}>
// 												<Select
// 													value={searchFilter?.search?.guestsRange?.start}
...
// 											<FormControl sx={{ width: '122px' }}>
// 												<Select
// 													value={searchFilter?.search?.guestsRange?.end}
			...
			<>
				<Stack className={'search-box'}>
					...
					<div className={`filter-rooms ${openRooms ? 'on' : ''}`} ref={roomsRef}>
						{[1, 2, 3, 4, 5].map((room: number) => {
							return (
								<span onClick={() => propertyBathSelectHandler(room)} key={room}>
									{room} bath{room > 1 ? 's' : ''}
								</span>
							);
						})}
									...
									<div className={'box'}>
										...
										<div className={'inside'}>
											<FormControl>
												...
												>
													<MenuItem value={'all'}>All Options</MenuItem>
													<MenuItem value={'propertyFamily'}>Family</MenuItem>
													<MenuItem value={'propertySeasonal'}>Seasonal</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
